...
INSERT INTO glass_colors (name, hex, family, sort_order) VALUES
  ('Black', '#010101', 'neutral', 10),
  ('Steel Blue', '#003f5a', 'blue', 20),
  ('Charcoal', '#4e4a42', 'neutral', 30),
  ('Pale Grey', '#7b8074', 'neutral', 40),
  ('Olive', '#0c2b2e', 'green', 50),
  ('Dark Green', '#154c3e', 'green', 60),
  ('Moss Green', '#23772d', 'green', 70),
  ('Celadon', '#9ea879', 'green', 80),
  ('Amazon Green', '#a1bd3a', 'green', 90),
  ('Pastel Green', '#9fd5b9', 'green', 100),
  ('Cobalt Blue', '#2b3278', 'blue', 110),
  ('Dark Blue', '#03569c', 'blue', 120),
  ('Medium Blue', '#415ba8', 'blue', 130),
  ('Mariner', '#2a5b8f', 'blue', 140),
  ('Riviera Blue', '#4d90cd', 'blue', 150),
  ('Turquoise Blue', '#0d9bc7', 'blue', 160),
  ('Alpine Blue', '#3f8b9d', 'blue', 170),
  ('Cloud', '#c1cdca', 'neutral', 180),
  ('Turquoise Green', '#15b9b0', 'green', 190),
  ('Peacock Green', '#027d71', 'green', 200),
  ('Violet', '#2a1423', 'purple', 210),
  ('Plum', '#46222f', 'purple', 220),
  ('Lilac', '#7b6269', 'purple', 230),
  ('Mauve', '#ddc3cb', 'purple', 240),
  ('Pale Purple', '#c68c85', 'purple', 250),
  ('Bronze', '#633d2a', 'brown', 260),
  ('Antique Bronze', '#543a23', 'brown', 270),
  ('Chestnut', '#7d4e2f', 'brown', 280),
  ('Terra Cotta', '#ae6219', 'brown', 290),
  ('Champagne', '#f9c996', 'amber', 300),
  ('Red', '#910028', 'red', 310),
  ('Flame/Light Cherry', '#e09090', 'red', 320),
  ('Orange', '#f15f25', 'red', 330),
  ('Persimmon', '#f37f43', 'red', 340),
  ('Marigold', '#faab54', 'amber', 350),
  ('Sunflower', '#eeb211', 'amber', 360),
  ('Dark Champagne', '#fbd0a0', 'amber', 370),
  ('Almond', '#fbf8df', 'neutral', 380),
  ('Ivory', '#ebebdb', 'neutral', 390),
  ('White', '#ffffff', 'neutral', 400)
